...
const CampaignView = () => {
    return (
        <Fragment>
            <div className="mb-10 h-[140px] text-[40px] font-bold rounded-3xl bg-no-repeat gradient-banner object-cover bg-center  flex items-center justify-center text-white">
                <h1> Education</h1>
            </div>
